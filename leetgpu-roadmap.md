...
> 图例：✅ 用户手写完成 | 📝 Agent 参考已有 | ⏳ 待用户手写

| # | 算子 | v0 | v1 | v2 | v3 | v4 | 实测性能 |
|---|------|:--:|:--:|:--:|:--:|:--:|------|
| 1 | GEMM | ✅ W2 | 📝 | ⏳ | ⏳ | ⏳ | |
| 2 | Softmax | 📝 | 📝 | 📝 | ⏳ | - | |
| 3 | RMSNorm | 📝 | 📝 | ⏳ | - | - | |
...
**当前状态 (2026-06-22)**：Week 2 完成，即将进入 Week 3（gemm_tiled + softmax 手写）。
仓库 `.cu` 文件为 Agent 参考实现，用户需要在 LeetGPU/4090 上从零手写并验证。

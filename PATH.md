...
| B2 | [08 triton-softmax 迁移检查点](./lessons/08-triton-fused-softmax.md) | Triton Softmax 一维 LeetGPU 原始通过版→[fused_softmax.py](./solutions/triton/fused_softmax.py) | `LEETGPU_PASS`：SuccessPublicTrace，2026-09-01 00:37:33，0.29 ms，47.0th percentile；服务器二维 row-wise baseline 待做，完成后立即 B3 | [Lesson 04](./lessons/04-softmax.md) · [Lesson 07 调试](./lessons/07-triton-debugging.md) | LEETGPU_PASS 当前；服务器待做 |

...
**当前（2026-08-20）**：
- 算子线：A1-A3 ✅；A4 3-pass/2-pass ✅，1-pass true online 为后置 CUDA 草稿 `softmax_1pass.cu`；warp shuffle/三版 benchmark 暂缓。A5 Flash Attn 读码 ✅（2026-08-10，阅读笔记 `notes/cuda/flash-attn-reading.md`，发现 2 个真实 bug）。B1 Triton vec_add 已由用户自己从头写完并通过 LeetGPU（2026-08-20），待真实 GPU benchmark；matmul 待做。

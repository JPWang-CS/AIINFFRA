...
| 论文 | 年份 | 优先级 | 状态 | 笔记 |
|------|------|--------|------|------|
| ZeRO: Memory Optimizations Toward Training Trillion Parameter Models | 2020 | P0 | ⏳ | |
...
| 论文 | 年份 | 优先级 | 状态 | 笔记 |
|------|------|--------|------|------|
| Triton: An Intermediate Language and Compiler for Tiled Neural Network Computations | 2019 | P0 | ⏳ | |

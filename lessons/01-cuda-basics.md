...
- [内存层级详解](../notes/cuda/memory-model.md) — Day 1 内存部分
- [Warp 与同步](../notes/cuda/warp-and-sync.md) — Day 1 warp 部分
- [GPU 架构对比](../notes/cuda/gpu-architecture.md) — Ascend ↔ NVIDIA
...
> 这些文档覆盖完整原理，本课只做梗概。遇到不懂的跳过去读。

| 想深入理解 | 去看 |
|-----------|------|
| CUDA 所有 API 的快速查阅 | [cuda-cheatsheet.md](../notes/cuda/cuda-cheatsheet.md) |
| 内存层级、coalescing、bank conflict | [memory-model.md](../notes/cuda/memory-model.md) |
| Warp 调度、divergence、shuffle、同步 | [warp-and-sync.md](../notes/cuda/warp-and-sync.md) |
